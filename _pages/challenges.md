...
![]({{ "/assets/img/methods/fitness_2.png" | relative_url }}){:style="margin:auto; display:block;width:70%"}
...
![]({{ "/assets/img/methods/cooking_2.jpg" | relative_url }}){:style="margin:auto; display:block;width:70%"}
<br/>
