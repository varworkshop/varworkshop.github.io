...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-follow-our-social-media-page-here-x-and-here-bsky-for-latest-updates",
          title: 'Follow our social media page here (X) and here (bsky) for latest updates....',
          description: "",
